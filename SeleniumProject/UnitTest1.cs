...
namespace SeleniumProject
{
    ...
    public class GoogleSearchTest
    {
        ...
        public static IEnumerable<TestData> TestCases => XmlDataReader.ReadTestData("T:\\הנדסת תוכנה\\שנה ב\\קבוצה א\\משתלמות\\יהודית פרידמן\\אוטומציה\\‏‏SeleniumProject - עותק\\SeleniumProject\\TestData.xml");
